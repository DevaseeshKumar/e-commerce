                            ...
                            <div key={order._id} className="card overflow-hidden animate-in bg-white dark:bg-[#1C1C1E] border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm hover:shadow-md transition-shadow" style={{ animationDelay: `${(i % 10) * 50}ms` }}>
                                ...
                                <div className="p-6">
                                    <div className="space-y-4">
                                            ...
                                            return (
                                                <div key={idx} className="flex gap-4 p-4 rounded-xl border border-transparent hover:bg-gray-50 dark:hover:bg-[#252528] hover:border-gray-200 dark:hover:border-white/10 transition-colors">
                                                    <div className="w-20 h-20 bg-gray-100 dark:bg-black rounded-xl overflow-hidden border border-gray-200 dark:border-white/10 shrink-0 flex items-center justify-center cursor-pointer" onClick={() => handleViewClick(item.product?._id)}>
                                                        {item.product?.image ? (
                                                    ...
                                                    <div className="font-bold my-auto mr-4 text-gray-900 dark:text-gray-100">
